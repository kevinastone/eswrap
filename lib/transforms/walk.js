...
import { Context, Gate, LinkedGate, ChainedGate } from '../gate';
import { indent, dedent, space, br, nobr, text } from '../token';
...
export function walkConnectingOperator(ctx: Context, writer: NodeWriter, lhs: CurriedWalker, op: CurriedWalker, rhs: CurriedWalker): Context {
  const gate = new ChainedGate();
